...
class OnlineTest extends JFrame implements ActionListener
{
	...
	void set()
	{
		...
		if(current==0)
		{
			l.setText("Que1: What is the most important feature of Java?");
			jb[0].setText("Java is a platform independent language.");jb[1].setText("Java is a platform dependent language.");jb[2].setText("Java is a platform notdepende language.");jb[3].setText("All above");	
		}
		if(current==1)
		{
			l.setText("Que2: 	
